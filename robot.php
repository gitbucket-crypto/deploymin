...
function checkforFilesUpdate()
{
    ...
    if($res['code']==202 | $res['code']=='202')
    {
        echo 'update modem.py'."\r\n";
        logger('updating modem.py');
        killPython();
        unlink(__DIR__.DIRECTORY_SEPARATOR.'modem.py');  
        download('modem.py');        
    }
    ...
    if($res['code']==202 | $res['code']=='202')
    {
        echo 'update comando.py'."\r\n";
        logger('updating comando.py');
        killPython();
        unlink(__DIR__.DIRECTORY_SEPARATOR.'comando.py');  
        download('comando.py');        
    }
    else
    {
